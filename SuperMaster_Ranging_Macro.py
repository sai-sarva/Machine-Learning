...
MACRO_FILE = 'C:/Users/sayan/Likewize/Operations Data Warehouse - Macro_TsnCube/SUPERMASTER_WEEKLY_RANGING_TOOL.xlsm'
...
def run_macro():
    ...
    for macro in MACRO_NAMES:
        ...
        try:
            ...
            # End timing and calculate elapsed time even in case of an error
            end_time = time.time()
            execution_time = end_time - start_time
